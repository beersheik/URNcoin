                    ...
                    <Row>
                        <Col lg={6} className="my-4 m-auto">
                            <Card className="login-card p-5">
                                <h2 className="clr-primary text-align-center"><b> Login</b></h2>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">Keep me signed in on this computer</label>
                                </div>
                                ...
                                <div className="text-align-center">Don't have an account yet? <span className="clr-primary">Sign Up!</span></div>
                            </Card>
                        </Col>
                    </Row>
                </Container>
